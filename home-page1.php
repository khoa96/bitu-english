  ...
  <div class="background-common">
    <div class="page-content-wrapper-common home-page-wrapper">
      ...
      <div class="home-page-content-wrapper">
        <div class="container home-page-intro-content">
          <div class="common-block-content review-template-class">
            <div class="common-badge-wrapper">
              <div class="back-background"></div>
              <div class="front-background">
                <span class="text-label">Bắt đầu với Bitu</span>
              </div>
            </div>
            <div class="content-detail-wrapper">
              <div class="title-block">
                <img src="./images/icon-step-1.png" class="icon-step-1" alt="">
                <h3 class="txt-title">Xem lớp học mẫu</h3>
              </div>
              <div class="list-class">
                <div class="class-item">
                  <div class="class-title-block">
                    <img src="./images/icon-flag-1.png" class="icon-flag" alt="">
                    <h4 class="class-title">Lớp học với giáo viên Native</h4>
                  </div>

                  <div class="list-teacher">
                    <div class="teacher-item">
                      <img src="./images/teacher-1.png" class="teacher-image" alt="">
                      <span class="teacher-name">Juliet</span>
                    </div>
                    <div class="teacher-item">
                    ...
                    <div class="teacher-item">
                      ...
                      <span class="teacher-name">Hannah</span>
                    </div>
                    <div class="teacher-item">
                 ...
                 <div class="class-item">
                  <div class="class-title-block">
                    <img src="./images/icon-flag-2.png" class="icon-flag" alt="">
                    <h4 class="class-title">Lớp học với giáo viên Philippines</h4>
                  </div>

                  <div class="list-teacher">
                    <div class="teacher-item">
                      <img src="./images/teacher-5.png" class="teacher-image" alt="">
                      <span class="teacher-name">Cera</span>
                    </div>
                    <div class="teacher-item">
                      <img src="./images/teacher-6.png" class="teacher-image" alt="">
                      <span class="teacher-name">Mon</span>
                    </div>
                    <div class="teacher-item">
                      <img src="./images/teacher-7.png" class="teacher-image" alt="">
                      <span class="teacher-name">Anna</span>
                    </div>
                    <div class="teacher-item">
                      <img src="./images/teacher-8.png" class="teacher-image" alt="">
                      <span class="teacher-name">Rose</span>
                    </div>
                  </div>
                  <button class="common-btn btn-view-teacher">
                  <img src="./images/icon-btn-1.png" class="icon-btn-1" alt="">
          ...
          <div class="common-block-content">
            <div class="content-detail-wrapper check-and-try-learn-block">
              <div class="left-content">
                ...
                <ul class="list-option">
                  <li class="option-item">
                    ...
                    <p class="txt-detail">25 phút học thử với giáo viên nước ngoài</p>
                  </li>
                  <li class="option-item">
                    <img src="./images/icon-check.png" class="icon-check" alt="">
                    <p class="txt-detail">Nhận đánh giá chi tiết khả năng NGHE/NÓI</p>
                  </li>
                </ul>
            </div>
            <div class="right-content">
              <div class="common-topic-item big-topic">
                <div class="topic-header">
                  <img src="./images/topic-image-2.png" class="topic-image" alt="">
                </div>
                <div class="topic-content">
                  ...
                  <div class="topic-footer">
                    <div class="left-content">
                     ...
                     <!-- <div class="action-block">
                        <img src="./images/icon-listen.png" class="action-icon" alt="">
                    ...
                    <button class="common-btn btn-join-topic">
                      <img src="./images/icon-btn-1.png" class="icon-btn-1" alt="">
                      <img src="./images/icon-btn-2.png" class="icon-btn-2" alt="">
                      <span class="text-btn">Đặt lịch</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <button class="common-control-roadmap btn-next">
          <span class="btn-text">Xem lộ trình học cho bé</span>
