...
<body>
  <div class="home-page-wrapper">
    ...
    <div class="home-page-content-mask">
      ...
      <div class="block-page-wrapper">
        <div class="container">
          <div class="block-page-content">
            <img src="./images/image-user-block.png" class="image-user-block" alt="">

            <div class="block-page-content__description">
              <h3 class="title-description">
                ...
                <span>Mở khóa tính năng Nói chuyện theo chủ đề</span>
              </h3>
              <p class="txt-description">Bạn cần đạt trình độ Mover để bắt đầu sử dụng</p>
            </div>
          </div>
        </div>
      </div>
